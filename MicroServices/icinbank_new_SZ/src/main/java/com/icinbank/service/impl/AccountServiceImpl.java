...
public class AccountServiceImpl implements AccountService{
	...
	public DepositResponse deposit(long acc, int amount) {
		...
		try {
			...
			dao.save(account);
			response.setResponseMessage("Rs."+amount+" Successfully deposited into your account. Available Balance is Rs."+account.getBalance());
			...
			if(account.getBalance()>=amount) 
				{
					...
					dao.save(account);
					response.setResponseMessage("Rs."+amount+" Successfully withdrawn your account. Available Balance is Rs."+account.getBalance());
